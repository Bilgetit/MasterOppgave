...
Do you have research data? The answer is always \enquote{yes}, even if you don't have the typical spread sheet with numbers. Everything you produce, from notes, lab journal, \LaTeX, code, figures, images etc. are examples of data. Before you start your project, you should make a plan for all this. Which kinds of data do you expect, how do you plan to store them during and after your project, can they be reused by your research group after you finish etc.?  
