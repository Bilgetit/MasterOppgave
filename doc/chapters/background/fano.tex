...
\begin{corollary} \label{cor:Fano}
    \todo{cite EO 22.31} For a hypersurface $S_d \subseteq \mathbb{P}^3$ of degree $d$, we expect to find no lines on $S_d$ when $d \geq 4$, finitely many lines when $d=3$, and positive-dimensional families of lines when $d \leq 2$.
\end{corollary}