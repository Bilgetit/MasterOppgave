...
\begin{lemma}\label{lem:irred_fiber}
    Let $X$ be a finite type scheme, and let $\pi \colon X \to Y$ be a proper morphism to an irreducible variety, and all the fibers are nonempty and irreducible of the same dimension. Then $X$ is irreducible.
\end{lemma}
