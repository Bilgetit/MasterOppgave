...
\begin{definition}
    An $m$-cross is a union of $m$ lines $l_1, l_2, \dots, l_m$ in $\mathbb{P}^3$ which intersect at a common point $p$ and lying in a common plane $H$. We will write $Z_m = \bigcup_{i=1}^m l_i$.
\end{definition}
...
\begin{proof}
    Let $S_d = V(f)$ for some $f \in \Bbbk[x_0, x_1, x_2, x_3]_d$ be a surface which includes $Z_m$. Since $Z_m$ is included in 
    $H$, we write $f$ as $f = g(x_0,x_1,x_2) + x_3h(x_0,x_1,x_2,x_3)$, separating the part of $f$, $x_3h(x_0,x_1,x_2,x_3)$, which vanishes on the plane. Saying that $Z_m \subseteq S_d$ is the same as saying $f|_{Z_m} = 0$, which implies that $g(x_0,x_1,x_2)|_{Z_m} = 0$, since $x_3h(x_0,x_1,x_2,x_3)|_{Z_m}$ already vanishes. This implies that $l_1l_2 \cdots l_m$ divides $g(x_0,x_1,x_2)$, meaning $g(x_0,x_1,x_2) = l_1l_2 \dots l_m \cdot j(x_0,x_1,x_2)$ for some $j(x_0,x_1,x_2) \in \Bbbk[x_0,x_1,x_2]_{d-m}$. Thus, we can write $f$ as $f = l_1l_2 \cdots l_m \cdot j(x_0,x_1,x_2) + x_3h(x_0,x_1,x_2,x_3)$, where $h(x_0,x_1,x_2,x_3) \in \Bbbk[x_0,x_1,x_2,x_3]_{d-1}$.

    Since we can choose $j(x_0,x_1,x_2)$ and $h(x_0,x_1,x_2,x_3)$ freely, we get that $\dim{A_m} = \dim \Bbbk[x_0,x_1,x_2]_{d-m} + \dim \Bbbk[x_0,x_1,x_2,x_3]_{d-1} = \binom{d-m+2}{2} + \binom{d+2}{3} - 1$. We subtract 1 to account for the fact that we are working in projective space. (!?)
\end{proof}
