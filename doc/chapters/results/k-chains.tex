...
\begin{lemma}
    $Q_m$ is an irreducible variety \todo{verify} of dimension $3m + 1$ for $m \geq 1$. \todo{Is $m \geq 1$ necessary?}
\end{lemma}
\label{lem:dimQm}
...
\begin{proof}
    ...
    \todo[inline]{Should we denote the fiber over a point as the whole m-tuple, or just the last line?}
...
\todo[inline]{Finish proof. It seems this can be explained by schubert cycles, 3.3.1 in EH. This can maybe be a subsection in preliminaries. The proof can be modified if this is included in preliminaries.}
