...
\begin{remark}
    Note that it is important that we consider the incidence variety of over specifically the smooth cubic surfaces, including a general 6-chain. If not, one can prove that the fiber of the union of 3 planes, will include a much higher dimensional family of 6-chains, and so the incidence variety will not be irreducible. (!?)
\end{remark}
