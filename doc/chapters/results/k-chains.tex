...
\begin{lemma}
    Let $Q_m \subseteq \mathbb{G}(1,3)^m$ be the subset of m-tuples of lines $(l_1, \dots, l_m)$ such that they form an $m$-chain. Then $Q_m$ is an irreducible variety \todo{verify} of dimension $3m + 1$.
\end{lemma}
\label{lem:dimQm}
