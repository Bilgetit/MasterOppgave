...
Note: In this proposition, we use the notion of a general 6-chain instead of a regular 6-chain. We are able to prove this result for a regular 6-chain as well, which but it is simpler, and relies on our definition of regular.
...
Note that this means that the 6-chains included in smooth surfaces are not general. To see why this might be, note that requiring that pairs of lines in dd
$\mathbb{P}^3$ do not meet is a Zariski-open condition(!?). This requirement is included in the definition of a regular $m$-chain.
...
\todo[inline]{Include section in background about intersection theory, Hodge index theorem etc.}
